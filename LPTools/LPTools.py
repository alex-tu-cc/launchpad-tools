...
class LPTools(object):
    ...
    def __init__(self, credentials_file, credental_application=None,
                 project=None):
        """TODO: to be defined1. """
        if credental_application is not None:
            self.credental_application = credental_application
        self.lp = Launchpad.login_with(self.credental_application,
